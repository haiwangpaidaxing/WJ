...
public sealed partial class MonsterData :  Bright.Config.BeanBase 
{
    ...
    public MonsterData(int untID, string unitName, string ResName, Data.Attribute RoleAttribute ) 
    {
        this.UntID = untID;
    ...
    {
        return new Data.MonsterData(_json);
    }
    ...
    public const int __ID__ = -801729952;
